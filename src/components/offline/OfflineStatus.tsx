  ...
  return (
    <Paper
      ...
      sx={{
        ...
        alignItems: 'center',
        gap: 1,
        backgroundColor: isOnline ? theme.palette.warning.light : theme.palette.error.main,
        color: '#fff',
        maxWidth: '100%',
        width: 'auto',
        borderRadius: 2,
    ...
    >
      ...
      <Box>
        <Typography variant="body1" fontWeight="bold">
          {!isOnline ? 'You are offline' : `${pendingChanges} changes pending sync`}
        </Typography>
      ...
      {isOnline && showSyncButton && pendingChanges > 0 && (
        <Button
          variant="contained"
          color="inherit"
          size="small"
