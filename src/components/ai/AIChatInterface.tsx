...
import { Box, Typography, Paper, TextField, Button, CircularProgress, Avatar } from '@mui/material';
import SendIcon from '@mui/icons-material/Send';
import { useAppDispatch, useAppSelector } from '@store/index';
import { selectMessages, selectChatLoading, sendMessage } from '@store/slices/chatSlice';
        ...
        {messages.length === 0 ? (
          ...
          >
            <Typography variant="body1" align="center">
              Ask me anything about safety regulations, incident reporting, or how to improve your safety practices.
            </Typography>
          </Box>
        ) : (
