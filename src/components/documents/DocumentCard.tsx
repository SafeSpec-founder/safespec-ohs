...
import { Box, Typography, Paper, Chip, IconButton, Menu, MenuItem, Tooltip, Grid } from '@mui/material';
...
const DocumentCard: React.FC<DocumentCardProps> = ({
  ...
  const getFileIcon = () => {
    if (!document.fileType) return <ArticleIcon fontSize="large" color="action" />;
