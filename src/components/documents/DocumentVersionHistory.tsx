...
import { Box, Typography, Paper, Tabs, Tab, Divider, List, ListItem, ListItemText, ListItemIcon, Chip, IconButton, Tooltip } from '@mui/material';
    ...
    <Paper elevation={3} sx={{ borderRadius: 2 }}>
      ...
      <TabPanel value={value} index={0}>
        ...
        <Typography variant="body2" color="text.secondary" paragraph>
          This document has {versions.length} versions. The current version is {document.version}.
        </Typography>
                ...
                <ListItemText
                  ...
                  secondary={
                    <>
                      ...
                      {" — "}
                      {formatDate(version.updatedAt)} ({formatTimeAgo(version.updatedAt)})
                      {version.comment && (
