...
import { Box, Typography, Paper, Chip, IconButton, Menu, MenuItem, Tooltip, Grid, LinearProgress } from '@mui/material';
...
const IncidentCard: React.FC<IncidentCardProps> = ({
  ...
  const getSeverityIcon = () => {
    switch (incident.severity) {
      ...
      case 'critical':
        return <ReportProblemIcon color="error" sx={{ transform: 'scale(1.2)' }} />;
      default:
