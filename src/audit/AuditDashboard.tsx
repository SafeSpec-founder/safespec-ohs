...
import { Typography, Box, Button, Grid, Paper, TextField, InputAdornment, Tabs, Tab, Table, TableBody, TableCell, TableContainer, TableHead, TableRow } from '@mui/material';
                      ...
                      <TableRow key={audit.id}>
                        ...
                        <TableCell>
                          <Box sx={{ 
                            ...
                            py: 0.5, 
                            bgcolor: 
                              audit.status === 'approved' ? 'success.light' : 
                              audit.status === 'rejected' ? 'error.light' : 
                              audit.status === 'completed' ? 'info.light' : 
                              audit.status === 'in-progress' ? 'warning.light' : 
                              'grey.300',
                            borderRadius: 1,
                            fontSize: '0.75rem',
                            fontWeight: 'bold'
                      ...
                      <TableRow key={finding.id}>
                        ...
                        <TableCell>
                          <Box sx={{ 
                            ...
                            py: 0.5, 
                            bgcolor: 
                              finding.severity === 'critical' ? 'error.main' : 
                              finding.severity === 'high' ? 'error.light' : 
                              finding.severity === 'medium' ? 'warning.main' : 
                              'success.light',
                            color: 'white',
                            borderRadius: 1,
                            fontSize: '0.75rem',
                        ...
                        <TableCell>
                          <Box sx={{ 
                            ...
                            py: 0.5, 
                            bgcolor: 
                              finding.status === 'resolved' ? 'success.light' : 
                              finding.status === 'in-progress' ? 'warning.light' : 
                              finding.status === 'open' ? 'error.light' : 
                              'grey.300',
                            borderRadius: 1,
                            fontSize: '0.75rem',
                            fontWeight: 'bold'
                        ...
                        <TableCell>{finding.dueDate ? new Date(finding.dueDate).toLocaleDateString() : 'N/A'}</TableCell>
                        <TableCell>
                          <Button 
                            size="small" 
