    ...
    setTimeout(() => {
      resolve({
        ...
        standardsCompliance: [
          ...
          { name: 'EPA Regulations', compliance: 65, status: 'partially-compliant' },
        ...
        recentFindings: [
          { id: 'F-001', standard: 'OSHA 1910', requirement: '1910.132', description: 'Missing PPE in chemical storage area', severity: 'high', status: 'open', dueDate: '2025-06-15' },
          { id: 'F-002', standard: 'ISO 45001', requirement: '8.1.2', description: 'Inadequate hazard communication procedures', severity: 'medium', status: 'in-progress', dueDate: '2025-06-10' },
          { id: 'F-003', standard: 'NFPA 70E', requirement: '130.5', description: 'Arc flash risk assessment not completed', severity: 'critical', status: 'open', dueDate: '2025-06-05' },
          { id: 'F-004', standard: 'EPA Regulations', requirement: '40 CFR 262.34', description: 'Improper hazardous waste storage', severity: 'high', status: 'in-progress', dueDate: '2025-06-20' },
          { id: 'F-005', standard: 'ANSI Z10', requirement: '5.1.1', description: 'Management review not conducted', severity: 'low', status: 'closed', dueDate: '2025-06-25' }
        ],
        upcomingAssessments: [
          { id: 'A-001', name: 'Quarterly OSHA Compliance Review', standard: 'OSHA 1910', scheduledDate: '2025-06-15', assignedTo: 'John Smith' },
          { id: 'A-002', name: 'Annual ISO 45001 Audit', standard: 'ISO 45001', scheduledDate: '2025-07-10', assignedTo: 'Sarah Johnson' },
          { id: 'A-003', name: 'Electrical Safety Assessment', standard: 'NFPA 70E', scheduledDate: '2025-06-22', assignedTo: 'Michael Brown' }
        ]
      });
    }, 1000);
  });
  ...
  return (
    <Box sx={{ flexGrow: 1, p: 3 }}>
      ...
      <Typography variant="subtitle1" color="textSecondary" gutterBottom>
        Welcome back, {user?.firstName || 'User'}. Here's your compliance overview.
      </Typography>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: 200 }}>
              <Box sx={{ position: 'relative', display: 'inline-flex' }}>
                <CircularProgress
                  ...
                  thickness={5}
                  sx={{
                    color: dashboardData.overallCompliance >= 80 
                    ...
                    {dashboardData.upcomingAssessments.map((assessment) => (
                      <TableRow key={assessment.id}>
                        ...
                        <TableCell>
                          ...
                          <Button size="small" variant="contained" color="primary">Start</Button>
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
