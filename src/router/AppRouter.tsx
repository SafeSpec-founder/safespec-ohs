    ...
    <Routes>
      ...
      <Route element={
        ...
        <Route path="/incidents/new" element={
          <ProtectedRoute requiredPermissions={[PERMISSIONS.CREATE_INCIDENTS]}>
            <IncidentFormPage />
          </ProtectedRoute>
        } />
        ...
        <Route path="/documents/new" element={
          <ProtectedRoute requiredPermissions={[PERMISSIONS.CREATE_DOCUMENTS]}>
            <DocumentFormPage />
          </ProtectedRoute>
        } />
        ...
        <Route path="/corrective-actions" element={
          <ProtectedRoute requiredPermissions={[PERMISSIONS.VIEW_CORRECTIVE_ACTIONS]}>
            <CorrectiveActionsPage />
          </ProtectedRoute>
        } />
        <Route path="/corrective-actions/:id" element={
          <ProtectedRoute requiredPermissions={[PERMISSIONS.VIEW_CORRECTIVE_ACTIONS]}>
            <CorrectiveActionDetailsPage />
          </ProtectedRoute>
        } />
        <Route path="/corrective-actions/new" element={
          <ProtectedRoute requiredPermissions={[PERMISSIONS.CREATE_CORRECTIVE_ACTIONS]}>
            <CorrectiveActionFormPage />
          </ProtectedRoute>
        } />
        <Route path="/corrective-actions/:id/edit" element={
          <ProtectedRoute requiredPermissions={[PERMISSIONS.EDIT_CORRECTIVE_ACTIONS]}>
            <CorrectiveActionFormPage />
          </ProtectedRoute>
        } />
