 ...
 */
export const getEffectivePermissions = (userRole: string, userPermissions: string[] = []): string[] => {
...
export const canAccessRoute = (
  ...
  if (requiredPermissions.length > 0) {
    const effectivePermissions = getEffectivePermissions(userRole, userPermissions);
