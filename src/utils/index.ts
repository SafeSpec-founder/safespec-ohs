...
export const fileUtils = {
   ...
   */
  getFileType(filename: string): 'image' | 'document' | 'spreadsheet' | 'presentation' | 'pdf' | 'video' | 'audio' | 'other' {
    if (!filename) return 'other';
    
    const extension = this.getFileExtension(filename);
    
    const fileTypes: Record<string, 'image' | 'document' | 'spreadsheet' | 'presentation' | 'pdf' | 'video' | 'audio' | 'other'> = {
      // Images
      jpg: 'image',
      jpeg: 'image',
      png: 'image',
