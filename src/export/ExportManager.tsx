...
const ExportManager: React.FC = () => {
  // const { user: currentUser } = useAuth(); // Commented out - unused
  // const { highContrast } = useAccessibility(); // Commented out - unused
              ...
              <Grid item xs={12} md={6}>
                ...
                <TextField
                  ...
                  SelectProps={{
                    native: true,
                    inputProps: {
                      title: "Report Template", // ✅ Correct location for title
                      'aria-label': "Report Template" // ✅ Optional but recommended
                    }
                  }}
                ...
                <TextField
                  ...
                  SelectProps={{
                    native: true,
                    inputProps: {
                      title: "Report Format", // ✅ Correct location for title
                      'aria-label': "Report Format" // ✅ Optional but recommended
                    }
                  }}
                />
                ...
                <TextField
                  ...
                  SelectProps={{
                    native: true,
                    inputProps: {
                      title: "Date Range", // ✅ Correct location for title
                      'aria-label': "Date Range" // ✅ Optional but recommended
                    }
                  }}
                >
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} md={6}>
                ...
                <TextField
                  ...
                  aria-label="Select report template" title="Select a report template"
                >
                  {templates.map(template => (
                    <option key={template.id} value={template.id}>
                      {template.name}
              ...
              <Grid item xs={12} md={6}>
                ...
                <TextField
                  ...
                  SelectProps={{
                    native: true,
                    inputProps: {
                      title: "Schedule Type", // ✅ Correct location for title
                      'aria-label': "Schedule Type" // ✅ Optional but recommended
                    }
                  }}
                >
                  ...
                  <>
                    <TextField
                      ...
                      SelectProps={{
                        native: true,
                        inputProps: {
                          title: "Frequency", // ✅ Correct location for title
                          'aria-label': "Frequency" // ✅ Optional but recommended
                        }
                      }}
                    ...
                    {formData.frequency === 'weekly' && (
                      <TextField
                        ...
                        SelectProps={{
                          native: true,
                          inputProps: {
                            title: "Day of Week", // ✅ Correct location for title
                            'aria-label': "Day of Week" // ✅ Optional but recommended
                          }
                        }}
                      >
                    ...
                    {formData.frequency === 'monthly' && (
                      <TextField
                        ...
                        SelectProps={{
                          native: true,
                          inputProps: {
                            title: "Day of Month", // ✅ Correct location for title
                            'aria-label': "Day of Month" // ✅ Optional but recommended
                          }
                        }}
                      />
                    )}
