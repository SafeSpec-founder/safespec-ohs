...
export const createIncident = createAsyncThunk(
  ...
  async (incident: Omit<Incident, 'id' | 'createdAt' | 'updatedAt'>, { rejectWithValue }) => {
    try {
...
export const selectIncidentsFilters = (state: RootState) => state.incidents.filters;
export const selectIncidentsPagination = (state: RootState) => state.incidents.pagination;
