...
export const createDocument = createAsyncThunk(
  ...
  async (document: Omit<Document, 'id' | 'version' | 'createdAt' | 'updatedAt'>, { rejectWithValue }) => {
    try {
...
export const selectDocumentsFilters = (state: RootState) => state.documents.filters;
export const selectDocumentsPagination = (state: RootState) => state.documents.pagination;
