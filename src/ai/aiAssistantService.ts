...
class AIAssistantService {
  ...
  constructor() {
    this.baseUrl = import.meta.env.VITE_AI_ASSISTANT_ENDPOINT || 'https://ai.safespec.com/api';
   ...
   */
  async getSafetyRegulations(query: string, jurisdiction?: string): Promise<any> {
    try {
      const response = await axios.get(
        `${this.baseUrl}/regulations`,
        {
          params: {
            query,
            jurisdiction,
