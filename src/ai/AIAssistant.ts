...
export class AIAssistant {
  ...
  async analyzeDocument(documentContent: string, documentType: string): Promise<any> {
    try {
      return await aiAssistantService.analyzeDocument(documentContent, documentType);
    } catch (error) {
   ...
   */
  async generateSafetyReport(incidentData: any[], reportType: string): Promise<any> {
    try {
      return await aiAssistantService.generateSafetyReport(incidentData, reportType);
    } catch (error) {
  ...
  async getCorrectiveActionRecommendations(incidentData: any): Promise<any> {
    try {
      return await aiAssistantService.getCorrectiveActionRecommendations(incidentData);
    } catch (error) {
