...
class FirebaseApiService {
  ...
  async request(method: string, endpoint: string, data?: any, options?: RequestInit): Promise<any> {
  ...
  private async getCachedData(endpoint: string) {
    try {
      ...
      const store = db.transaction('offlineCache', 'readonly').objectStore('offlineCache');
