...
export const tenantService = {
  ...
  async inviteUser(email: string, role: string): Promise<any> {
    const response = await api.post('/tenants/current/users/invite', { email, role });
    return response.data;
  },
  ...
  async updateUserRole(userId: string, role: string): Promise<any> {
    const response = await api.put(`/tenants/current/users/${userId}/role`, { role });
    return response.data;
  },
  ...
  async updateModuleSettings(settings: any): Promise<any> {
    const response = await api.put('/tenants/current/settings/modules', settings);
    return response.data;
  },
  ...
  async updateFeatureSettings(settings: any): Promise<any> {
    const response = await api.put('/tenants/current/settings/features', settings);
    return response.data;
  },
