    ...
    const fetchIncident = async () => {
      try {
        ...
        const mockIncident = {
          ...
          description: 'Employee slipped on wet floor in warehouse section B-2. Minor injury to left ankle.',
          ...
          witnesses: [
            {
              ...
              name: 'Mike Johnson',
              role: 'Supervisor',
              statement: 'Saw the incident occur, floor was wet from recent cleaning.',
            },
          ],
          immediateActions: [
            'First aid provided',
          ...
          comments: [
            {
              ...
              content: 'Investigation initiated. Reviewing cleaning procedures.',
              timestamp: new Date('2024-01-15T15:00:00'),
            },
            {
              id: '2',
              author: 'HR Representative',
              content: 'Employee medical evaluation completed. Return to work approved with restrictions.',
                  ...
                  {incident.comments.map((comment: any) => (
                    <ListItem key={comment.id}>
                      ...
                      <ListItemText
                        ...
                        secondary={`${comment.author} - ${comment.timestamp.toLocaleDateString()}`}
                      />
                    </ListItem>
                  ))}
                </List>
                  ...
                  {incident.correctiveActions.map((action: any) => (
                    <ListItem key={action.id}>
                      ...
                      <ListItemText
                        ...
                        secondary={`Assigned to: ${action.assignedTo} | Due: ${action.dueDate.toLocaleDateString()} | Status: ${action.status}`}
                      />
                    </ListItem>
                  ))}
                </List>
                  ...
                  {incident.attachments.map((attachment: any) => (
                    <ListItem key={attachment.id}>
                      <ListItemText
                        ...
                        secondary={`${attachment.type} - ${attachment.size} - Uploaded: ${attachment.uploadedAt.toLocaleDateString()}`}
                      />
                    </ListItem>
                  ))}
                </List>
              ...
              <CardContent>
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    ...
                    <Typography variant="body1">{incident.reportedBy.name}</Typography>
                  </Box>
                </Box>
