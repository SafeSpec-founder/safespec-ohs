...
const EnhancedSettings: React.FC = () => {
  ...
  const handleDataRetentionChange = (e: React.ChangeEvent<HTMLSelectElement>): void => {
  ...
  const handleRefreshRateChange = (e: React.ChangeEvent<HTMLSelectElement>): void => {
          ...
          <div className="card-content">
            ...
            <div className="setting-item">
              <div className="setting-label">
                ...
                <span className="setting-description">Receive notifications within the app</span>
              </div>
              <div className="setting-control">
                <label className="toggle-switch">
                  <input 
            ...
            <div className="setting-item">
              <div className="setting-label">
                ...
                <span className="setting-description">Receive notifications on your desktop</span>
              </div>
              <div className="setting-control">
                <label className="toggle-switch">
                  <input 
          ...
          <div className="card-content">
            <div className="setting-item">
              <div className="setting-label">
                ...
                <span className="setting-description">How long to keep your data</span>
              </div>
              <div className="setting-control">
                <select 
                  className="form-control"
          ...
          <div className="card-content">
            <div className="setting-item">
              <div className="setting-label">
                ...
                <span className="setting-description">Display safety performance metrics on dashboard</span>
              </div>
              <div className="setting-control">
                <label className="toggle-switch">
                  <input 
            ...
            <div className="setting-item">
              <div className="setting-label">
                ...
                <span className="setting-description">How often to update performance metrics</span>
              </div>
              <div className="setting-control">
                <select 
                  className="form-control"
              ...
              <div className="metrics-grid">
                <div className="metric-preview-item">
                  ...
                  <div className="metric-content">
                    ...
                    <div className="metric-value">1.2 <span className="trend positive">-0.3</span></div>
                  </div>
                </div>
                ...
                <div className="metric-preview-item">
                  ...
                  <div className="metric-content">
                    ...
                    <div className="metric-value">92% <span className="trend positive">+2%</span></div>
                  </div>
                </div>
                ...
                <div className="metric-preview-item">
                  ...
                  <div className="metric-content">
                    ...
                    <div className="metric-value">98% <span className="trend positive">+1%</span></div>
                  </div>
                </div>
                ...
                <div className="metric-preview-item">
                  ...
                  <div className="metric-content">
                    ...
                    <div className="metric-value">87% <span className="trend negative">-3%</span></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="modal-overlay">
          <div className="modal-container">
            ...
            <div className="modal-body">
              ...
              <p>This change may have significant implications for your data.</p>
            </div>
            <div className="modal-footer">
              <button className="btn btn-secondary" onClick={() => setShowConfirmModal(false)}>Cancel</button>
              <button className="btn btn-primary" onClick={confirmActionHandler}>Confirm</button>
            </div>
          </div>
        </div>
      )}
