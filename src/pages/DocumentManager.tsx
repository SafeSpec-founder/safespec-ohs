    ...
    <div>
      ...
      <div className="dashboard-filters">
        <div className="search-container">
          ...
          />
          <button className="search-button" aria-label="Search documents" title="Search documents">
            <svg
          ...
          <div className="modal-container">
            ...
            <div className="modal-body">
              ...
              <div className="form-group">
                ...
                <select className="form-control" aria-label="Select document type" title="Select document type">
                  {documentTypes
              ...
              <div className="form-group">
                <label>Category</label>
                <select className="form-control" aria-label="Select document category" title="Select document category">
                  {categories
