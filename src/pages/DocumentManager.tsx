...
const DocumentManager: React.FC = () => {
  ...
  const categories = ['All', 'Safety', 'Incident Management', 'Equipment', 'Emergency', 'Chemical Safety'];
  const documentTypes = ['All', 'Procedure', 'Form', 'Checklist', 'Plan', 'Guideline', 'Report'];
          ...
          <div className="modal-container">
            ...
            <div className="modal-body">
              ...
              <div className="form-group">
                ...
                <textarea className="form-control" rows={3} placeholder="Enter document description"></textarea>
              </div>
            </div>
            <div className="modal-footer">
              <button className="btn btn-secondary" onClick={() => setShowUploadModal(false)}>Cancel</button>
              <button className="btn btn-primary" onClick={handleUploadDocument}>Upload</button>
            </div>
          </div>
        </div>
      )}
