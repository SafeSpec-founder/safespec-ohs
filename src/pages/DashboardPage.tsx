...
import { Box, Typography, Grid, Paper, Container, Card, CardContent, CardHeader, Divider } from '@mui/material';
          ...
          <Paper elevation={2} sx={{ p: 2, height: '100%', borderRadius: 2 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                <Typography variant="body1" fontWeight="bold" color={openIncidents > 0 ? 'warning.main' : 'success.main'}>
                  {openIncidents}
                </Typography>
              </Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                <Typography variant="body1" fontWeight="bold" color={criticalIncidents > 0 ? 'error.main' : 'success.main'}>
                  {criticalIncidents}
                </Typography>
              </Box>
            </Box>
          ...
          <Paper elevation={2} sx={{ p: 2, height: '100%', borderRadius: 2 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                <Typography variant="body1" fontWeight="bold" color={correctiveActions.filter(a => a.status === 'open').length > 0 ? 'warning.main' : 'success.main'}>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                ...
                <Typography variant="body1" fontWeight="bold" color={overdueActions > 0 ? 'error.main' : 'success.main'}>
                  {overdueActions}
                </Typography>
              </Box>
            </Box>
