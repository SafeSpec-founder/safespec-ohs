...
const ReportCreator: React.FC = () => {
  ...
  const exportToExcel = () => {
    ...
    setTimeout(() => {
      addToast({
        type: 'success',
        title: 'Excel Ready',
        message: 'Your Excel file has been generated and is ready for download.'
      });
    }, 2000);
  };
  ...
  const generateDocument = () => {
    ...
    if (reportFormat === 'pdf') {
      ...
      // Body
      const body = processedData.map((row: Record<string, string>) => Object.values(row));
        ...
        <div className="dashboard-card">
          ...
          <div className="card-content">
            <div className="generated-report-link">
              <p>Your report has been generated successfully. Click the button below to download it.</p>
              <a
