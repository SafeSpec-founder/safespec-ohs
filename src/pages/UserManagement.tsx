    ...
    <div className="dashboard-container user-management-page">
      ...
      <div className="filter-container">
        ...
        <div className="filter-box">
          ...
          <select id="roleFilter" value={filterRole} onChange={handleRoleFilter}>
        ...
        <div className="filter-box">
          ...
          <select id="statusFilter" value={filterStatus} onChange={handleStatusFilter}>
                        ...
                        <tr key={user.id}>
                          ...
                          <td>
                            <span className={`badge badge-${user.role}`}>
                              ...
                              {!['admin', 'manager', 'supervisor', 'user', 'readonly'].includes(user.role) && user.role}
                            </span>
                          </td>
                          <td>
      ...
      {showRoleModal && selectedUser && (
        <div className="modal-overlay">
          <div className="modal-container" role="dialog" aria-labelledby="role-modal-title">
            <div className="modal-header">
              <h2 id="role-modal-title">Change User Role</h2>
              <button className="modal-close" onClick={closeRoleSelector} aria-label="Close modal">
                &times;
              </button>
            </div>
            <div className="modal-content">
              <div className="user-info">
                ...
                <div className="user-details">
                  ...
                  <p>Current Role: <span className="badge badge-role">{selectedUser.role}</span></p>
                </div>
              </div>
              <RoleSelector
            ...
            <div className="modal-footer">
              <button className="dashboard-button secondary" onClick={closeRoleSelector}>
                Cancel
              </button>
            </div>
          </div>
