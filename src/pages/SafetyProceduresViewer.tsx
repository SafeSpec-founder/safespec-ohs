...
const SafetyProceduresViewer: React.FC<SafetyProceduresViewerProps> = ({ procedure, onClose, onDownload, onEdit }) => {
  ...
  return (
    ...
    >
      <div className="modal-overlay" onClick={onClose} role="dialog" aria-modal="true" aria-labelledby="procedure-viewer-title" aria-describedby="procedure-viewer-description">
        <div className="modal-content large" onClick={(e) => e.stopPropagation()}> {/* Prevent closing on content click */}
          <div className="modal-header">
            <h2 id="procedure-viewer-title">
              {procedure.title}
            </h2>
            <button
            ...
            <div className="procedure-content-viewer">
              <div className="procedure-meta-details">
                ...
                <div className="meta-item">
                  ...
                  <span className={`meta-value badge ${procedure.status === 'Active' ? 'badge-success' : procedure.status === 'Under Review' ? 'badge-warning' : 'badge-secondary'}`}>
                    {procedure.status}
                  </span>
                </div>
              </div>
          ...
          <div className="modal-footer">
            ...
            <button className="dashboard-button" onClick={onClose}>Close</button>
          </div>
        </div>
        <style>{`
