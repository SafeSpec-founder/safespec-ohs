...
const WeeklyReports: React.FC = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([reportsPromise, metricsPromise]).then(([loadedReports, loadedMetrics]) => {
  ...
  const handleDownloadReport = (report: Report) => {
    ...
    setTimeout(() => {
      ...
      const blob = new Blob([`Weekly Report Content for ${report.title} (${report.week})`], { type: 'application/pdf' });
      ...
      {performanceMetrics && (
        <div className="metrics-grid">
          <div className="metric-card">
            <div className="metric-value">{performanceMetrics.reportsSubmitted}</div>
            <div className="metric-label">Reports Submitted</div>
          </div>
          <div className="metric-card">
            <div className="metric-value">{performanceMetrics.complianceRate}%</div>
            <div className="metric-label">Compliance Rate</div>
          </div>
          <div className="metric-card">
            <div className="metric-value">{performanceMetrics.overdueTasks}</div>
            <div className="metric-label">Overdue Tasks</div>
          </div>
          <div className="metric-card">
            <div className="metric-value">{performanceMetrics.incidentsReported}</div>
        ...
        <>
          {filteredReports.length === 0 ? (
            ...
            <div className="table-container">
              ...
              <div className="table-scroll-container" style={{ maxHeight: 'calc(5 * 50px)', overflowY: 'auto' }}>
                      ...
                      <tr key={report.id}>
                        ...
                        <td>
                          ...
                          <div className="action-buttons">
                            ...
                            >
                              <span className="tooltip-content">Edit (coming soon)</span>
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                              </svg>
            ...
            <div className="modal-content">
              <div className="report-details">
                ...
                <div className="detail-row">
                  ...
                  <div className="detail-value">{selectedReport.type.charAt(0).toUpperCase() + selectedReport.type.slice(1)}</div>
                </div>
              </div>
              
              <div className="report-content">
                <h3>Report Content</h3>
                <p>This is placeholder content for the weekly report. Actual content would include summaries, findings, data, and action items relevant to the report type (e.g., performance metrics, audit results, inspection findings).</p>
              </div>
            </div>
