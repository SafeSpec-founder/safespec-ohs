          ...
          <div className="settings-card-content">
            <div className="settings-option">
              <div className="option-label">
                ...
                <span className="option-description">Receive alerts for important updates</span>
              </div>
            ...
            <div className="settings-option">
              <div className="option-label">
                ...
                <span className="option-description">Receive notifications via email</span>
              </div>
              <div className="option-control">
                <label className="toggle-switch">
                  <input
        ...
        <div className="settings-card">
          ...
          <div className="settings-card-content">
            <div className="settings-option">
              <div className="option-label">
                <span>Dark Mode</span>
                <span className="option-description">Use dark theme for the application</span>
              </div>
              <div className="option-control">
                <label className="toggle-switch">
                  <input
          ...
          <div className="settings-card-content">
            <div className="settings-option">
              <div className="option-label">
                ...
                <span className="option-description">How long to keep your activity data</span>
              </div>
              <div className="option-control">
                <select
                  value={dataRetention}
            ...
            <div className="settings-option">
              <div className="option-label">
                ...
                <span className="option-description">Get a copy of your personal data</span>
              </div>
              <div className="option-control">
